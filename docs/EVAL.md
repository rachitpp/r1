...
**Repo:** https://github.com/encode/httpx @ `b5addb64f016` — 1967 chunks (1270 implementation, 697 test), 20 questions. Modes: vector, fts, hybrid.
...
**Repo:** https://github.com/encode/httpx @ `b5addb64f016` — 1967 chunks (825 implementation, 697 test, 445 prose/config excluded), 20 questions. Modes: vector, fts, hybrid.
