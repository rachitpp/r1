...
/**
 * `/` — the library of already-indexed repos.
 *
 * The other half of the old `repo-dashboard` module; see `repo-submit.tsx` for
 * why they are two files. Reads the same `["repos"]` query the submit form
 * invalidates, so a new index appears here without its own refetch.
 */
...
import type { RepoOut } from "@/lib/api-types";
import {
  shortSha,
  splitRepoName,
  strategyTag,
